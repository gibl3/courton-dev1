...
<div class="flex flex-col gap-8">
    ...
    <div class="bg-white rounded-xl border border-neutral-200 p-6">
        <form action="{{ route('admin.bookings.pending') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
                <div class="relative">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-neutral-200">
                    ...
                    <tr class="hover:bg-neutral-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="font-medium">{{ $booking->user->fullName ?? 'N/A' }}</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        confirmStatusUpdate.addEventListener('click', function() {
            ...
            // Submit the update
            fetch('{{ route("admin.bookings.bulkUpdate") }}', {
                    method: 'POST',
                    headers: {
